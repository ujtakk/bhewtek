proc create_ipi_design { offsetfile design_name } {
	...
	set copro_0 [ create_bd_cell -type ip -vlnv ac.jp:user:copro:1.0 copro_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins copro_0/s_axi]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins copro_0/s_axi_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins copro_0/s_axi_ARESETN]
	...
	set offset_file "${bd_path}/copro_v1_0_tb_include.vh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores ac.jp:user:copro:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/copro_v1_0_tb.v
