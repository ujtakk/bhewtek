...
targets -set -filter {name =~"APU" && jtag_cable_name =~ "Digilent Zed 210248807204"} -index 0
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Digilent Zed 210248807204" && level==0} -index 1
...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zed 210248807204"} -index 0
dow /ram/home/work/takau/bhewtek/zedboard/zedboard.sdk/cnn/Debug/cnn.elf
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zed 210248807204"} -index 0
con
