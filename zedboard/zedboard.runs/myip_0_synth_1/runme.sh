...
HD_PWD='/ram/home/work/takau/bhewtek/zedboard/zedboard.runs/myip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source myip_0.tcl
