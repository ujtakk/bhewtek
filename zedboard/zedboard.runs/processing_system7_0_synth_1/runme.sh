...
HD_PWD='/ram/home/work/takau/bhewtek/zedboard/zedboard.runs/processing_system7_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_system7_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source processing_system7_0.tcl
