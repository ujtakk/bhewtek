...
#
# Generated by Vivado on Wed May 18 01:16:52 JST 2016
# IP Build 1537824 on Fri Apr  8 04:28:57 MDT 2016 
#
# usage: zboard.sh [-help]
# usage: zboard.sh [-lib_map_path]
# usage: zboard.sh [-noclean_files]
# usage: zboard.sh [-reset_run]
#
...
# executing this script. Please type 'zboard.sh -help' for more information.
#
...
# Script info
echo -e "zboard.sh - Script generated by export_simulation (Vivado v2016.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/zboard/ip/zboard_processing_system7_0_0/sim/zboard_processing_system7_0_0.v" \
    "$ref_dir/../../../bd/zboard/ip/zboard_axi_slave_top_wrapper_0_0/sim/zboard_axi_slave_top_wrapper_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/zboard/ip/zboard_rst_processing_system7_0_100M_0/sim/zboard_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/zboard/ip/zboard_auto_pc_0/sim/zboard_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/zboard/ip/zboard_auto_us_0/sim/zboard_auto_us_0.v" \
    "$ref_dir/../../../bd/zboard/hdl/zboard.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.zboard xil_defaultlib.glbl -o zboard_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./zboard_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./zboard.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(processing_system7_bfm_v2_0_5 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 fifo_generator_v13_1_0 axi_data_fifo_v2_1_7 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_8 axi_protocol_converter_v2_1_8 axi_clock_converter_v2_1_7 blk_mem_gen_v8_3_2 axi_dwidth_converter_v2_1_8)
...
reset_run()
{
  files_to_remove=(ucli.key zboard_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc zboard_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./zboard.sh -help\" for more information)\n"
    exit 1
  fi
