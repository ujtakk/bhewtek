...
#
# Generated by export_simulation on Wed May 25 13:13:34 JST 2016
#
################################################################################
...
switch to the './zboard.sh' script.
...
./zboard.sh -noclean_files

For more information on the script, please type './zboard.sh -help'.
