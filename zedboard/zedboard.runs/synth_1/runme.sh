...
HD_PWD='/ram/home/work/takau/bhewtek/zedboard/zedboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_system_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cnn_system_wrapper.tcl
